...
const BibliotecaDeFaturas: React.FC = () => {
  ...
  return (
    <Layout>
      <h1 className='text-3xl mb-4 px-4'>Biblioteca de Faturas</h1>
      <div className='ml-4 mb-4 p-4 border rounded-lg max-w-lg'>
        <div className='mb-4'>
        ...
        {filteredInvoices.map((invoice) => (
          <li key={invoice.id} className='mb-2'>
            <div className='flex justify-between items-center border p-2'>
              <span>
                {invoice.clientNumber} - {invoice.referenceMonth}
              </span>
              <button
